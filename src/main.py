...
def main():
    ...
    HEAD_TILT_THRESHOLD_lvl1 = 20
    HEAD_TILT_THRESHOLD_lvl2 = 40 #20 #15 # smaller threshold for more sensitivity
    NOSE_POSCHANGE_THRESHOLD = 15 
    ...
    # Logging setup
    log_file = "gesture_vehicle_log.csv"
    if os.path.exists(log_file):
        os.remove(log_file)
    with open(log_file, mode='w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["Time", "MouthOpen", "Frowning", "NoddingUp", "NoddingDown", "Throttle", "Brake", "Steer", "Gear"])
    ...
    try:
        while True:
            ...
            if results.multi_face_landmarks:
                ...
                # 2 levels steering for smooth steering
                if head_tilt_delta > HEAD_TILT_THRESHOLD_lvl1 and head_tilt_delta < HEAD_TILT_THRESHOLD_lvl2:
                    control.steer = -0.1
                elif head_tilt_delta > -HEAD_TILT_THRESHOLD_lvl2 and head_tilt_delta < -HEAD_TILT_THRESHOLD_lvl1: 
                    control.steer = 0.1 
                elif head_tilt_delta > HEAD_TILT_THRESHOLD_lvl2:
                    control.steer = -0.3
                elif head_tilt_delta < -HEAD_TILT_THRESHOLD_lvl2:
                    control.steer = 0.3
                else:
                ...
                # Logging gesture and vehicle state
